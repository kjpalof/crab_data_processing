...
```{r CPUE, echo = FALSE }
cpue_2017 <- read.csv("../results/redcrab/Peril/PS_CPUE_17.csv")
...
male_weights <- read.csv("../results/redcrab/Peril/maleweights.csv")
kable(male_weights, digits = 3)
```

## Short term trends in CPUE
```{r short term, echo = FALSE }
short_term_results <- read.csv("../results/redcrab/Peril/shortterm.csv")
...
long_term_results <- read.csv("../results/redcrab/Peril/longterm.csv")
...
poorclutch_17 <- read.csv("../results/redcrab/Peril/poorclutch_17.csv")
...
lt_female <- read.csv("../results/redcrab/Peril/lt_female.csv")
kable(lt_female, digits = 3)
```

####short term females
```{r short term female, echo = FALSE}
short_female <- read.csv("../results/redcrab/Peril/short_female.csv")
...
egg_per_mean <- read.csv("../results/redcrab/Peril/egg_percent_mean.csv")
...
stock_health <- read.csv("../results/redcrab/Peril/stock_health.csv")
