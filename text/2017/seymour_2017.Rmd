---
title: "Seymour Canal 2017 survey results"
author: "Katie Palof"
date: "August 8, 2017"
...
```{r CPUE, echo = FALSE }
cpue_2017 <- read.csv("../results/redcrab/Seymour/SC_CPUE_17.csv")
...
male_weights <- read.csv("../results/redcrab/Seymour/maleweights.csv")
kable(male_weights, digits = 3)
```

## Short term trends in CPUE
```{r short term, echo = FALSE }
short_term_results <- read.csv("../results/redcrab/Seymour/shortterm.csv")
...
long_term_results <- read.csv("../results/redcrab/Seymour/longterm.csv")
...
poorclutch_17 <- read.csv("../results/redcrab/Seymour/poorclutch_17.csv")
...
lt_female <- read.csv("../results/redcrab/Seymour/lt_female.csv")
kable(lt_female, digits = 3)
```

####short term females
```{r short term female, echo = FALSE}
short_female <- read.csv("../results/redcrab/Seymour/short_female.csv")
...
egg_per_mean <- read.csv("../results/redcrab/Seymour/egg_percent_mean.csv")
...
stock_health <- read.csv("../results/redcrab/Seymour/stock_health.csv")
